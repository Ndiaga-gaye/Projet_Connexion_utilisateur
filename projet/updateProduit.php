...
<html>
   ...
   <div id="conn">
            ...
            <h4 class=F> champ de  saisie pour Modifier des produit</h4>
            <p>
               <label for="nom">non produit</label>
            ...
            <p>
               <label for="quantité"> quantitées</label>
               <input type="text" name="quantité" id="Qantité">
            </p>
...
for($i=0; $i<count($produits); $i++){
      if($produits[$i][0]==$_POST["nom"]){
          if($_POST["prix"]!=""){
              $produits[$i][1]=$_POST["prix"];
          }
          if($_POST["quantité"]!=""){
              $produits[$i][2]=$_POST["quantité"];
          }
      }
  }
